...
public class ChildrenControllerTests
{
    ...
    public async Task GetChildren_WithAuthenticatedUser_ReturnsListOfChildren()
    {
        ...
        var familyChildren = new FamilyChildrenDto(
            ...
            {
                new ChildDetailDto(Guid.NewGuid(), Guid.NewGuid(), "Alice", "Smith", "alice@test.com", 100m, 0m, 10m, null, null, DayOfWeek.Friday, false, SavingsTransferType.None, null, null, true, false),
                new ChildDetailDto(Guid.NewGuid(), Guid.NewGuid(), "Bob", "Smith", "bob@test.com", 150m, 0m, 15m, DateTime.UtcNow.AddDays(-3), DateTime.UtcNow.AddDays(4), null, false, SavingsTransferType.None, null, null, true, false)
            });
